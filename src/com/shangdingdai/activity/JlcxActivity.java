...
import com.shangdingdai.fragment.HzcxFragment;
import com.shangdingdai.fragment.JyjlFragment;
...
public class JlcxActivity extends FragmentActivity {
	private ViewPager viewPager;// 页卡内容
	private ImageView imageView;// 动画图片
	private TextView tv_mr, tv_lv;// 选项名称
	...
	private void initView() {
		...
		mTextView.setText(R.string.jlcx);
	...
	private void InitViewPager() {
		...
		fragments.add(new JyjlFragment());
		fragments.add(new HzcxFragment());
	...
	private void InitTextView() {
		...
		tv_mr.setText(R.string.jyjl);
		tv_lv.setText(R.string.hzcx);
