...
import com.shangdingdai.fragment.GfggFragment;
import com.shangdingdai.fragment.XtxxFragment;
...
public class MyMessageActivity extends FragmentActivity {
	...
	private void initView() {
		...
		mTextView.setText(R.string.wdxx);
	...
	private void InitViewPager() {
		...
		fragments.add(new GfggFragment());
		fragments.add(new XtxxFragment());
	...
	private void InitTextView() {
		...
		tv_mr.setText(R.string.gfgg);
		tv_lv.setText(R.string.xtxx);
