...
import com.shangdingdai.fragment.XszxDefaultFragment;
import com.shangdingdai.fragment.XszxInterestRateFragment;
import com.shangdingdai.fragment.XszxMoneyFragment;
import com.shangdingdai.fragment.XszxTermFragment;
...
public class XszxAxtivity extends FragmentActivity{
	private ViewPager viewPager;// 页卡内容
	private ImageView imageView;// 动画图片
	private TextView tv_mr, tv_lv, tv_je ,tv_qx;// 选项名称
	...
	private void initView() {
		...
		mTextView.setText(R.string.xszx);
	...
	private void InitViewPager() {
		...
		fragments.add(new XszxDefaultFragment());
		fragments.add(new XszxInterestRateFragment());
		fragments.add(new XszxMoneyFragment());
		fragments.add(new XszxTermFragment());
	...
	private void InitTextView() {
		...
		tv_qx=(TextView) findViewById(R.id.tab_4);
		tv_mr.setTextColor(selectedColor);
		tv_lv.setTextColor(unSelectedColor);
		tv_je.setTextColor(unSelectedColor);
		tv_qx.setTextColor(unSelectedColor);
		tv_mr.setText(R.string.mr);
		tv_lv.setText(R.string.lv);
		tv_je.setText(R.string.je);
		tv_qx.setText(R.string.qx);
		...
		tv_qx.setOnClickListener(new MyOnClickListener(3));
	...
	private class MyOnClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case 3:
				...
				tv_lv.setTextColor(unSelectedColor);
				tv_je.setTextColor(unSelectedColor);
				tv_qx.setTextColor(selectedColor);
				break;
			}
