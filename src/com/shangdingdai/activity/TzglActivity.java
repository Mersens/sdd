...
import com.shangdingdai.fragment.HkzFragment;
import com.shangdingdai.fragment.TbzFragment;
import com.shangdingdai.fragment.YhqFragment;
import com.shangdingdai.view.R;

public class TzglActivity extends FragmentActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tzgl);
	...
	private void initView() {
		...
		mTextView.setText(R.string.tzgl);
	...
	private void InitViewPager() {
		...
		fragments.add(new HkzFragment());
		fragments.add(new TbzFragment());
	...
	private void InitTextView() {
		...
		tv_mr.setText(R.string.hkz);
		tv_lv.setText(R.string.tbz);
		tv_je.setText(R.string.yhq);
