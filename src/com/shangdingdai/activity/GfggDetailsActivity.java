...
public class GfggDetailsActivity extends BaseActivity {
	public ImageView mImageView;
	public TextView mTextView;
	private GfggItemBean bean=null;
	...
	private static final String URL = Constants.SERVICE_ADDRESS
			+ "systemMessage/loadingGonggaoById";
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		// TODO Auto-generated method stub
		super.onCreate(savedInstanceState);
		setContentView(R.layout.layout_gfgg_details);
		initViews();
		initEvents();
	...
	class MyAnsyTask extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			try {
				bean=JsonUtils.getGfggItemFromJson(result);
				if(bean==null){
					layout_no_msg.setVisibility(View.VISIBLE);
