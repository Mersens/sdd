...
public class SbtzMoneyFragment extends FragmentBase implements OnClickListener,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.layout_sbtz_je, null);
		initViews(v);
		if (!NetworkUtils.isNetworkAvailable(getActivity()
			...
			progressBar.setVisibility(View.VISIBLE);
			 mt = new MyAnsyTask();
			String params[] = { page + "", pagesize + "", "loanjine", "0" };
			mt.execute(params);
		}
		return v;
	}
