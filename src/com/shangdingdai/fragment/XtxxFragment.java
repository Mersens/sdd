...
import com.shangdingdai.activity.XtxxDetailsActivity;
import com.shangdingdai.adapter.XtxxAdapter;
...
public class XtxxFragment extends FragmentBase implements OnClickListener,
IXListViewListener, EventListener{
	...
	private static final String URL = Constants.SERVICE_ADDRESS
			+ "systemMessage/loadingMessageList";

	@SuppressLint("InflateParams")
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {
		View v=inflater.inflate(R.layout.layout_xtxx, null);
		initViews(v);
	...
	private void initEvents() {
		lists.addAll(list);
		adapter = new XtxxAdapter(list, getActivity().getApplicationContext());
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent=new Intent(getActivity(),XtxxDetailsActivity.class);
