...
public class XszxMoneyFragment extends FragmentBase implements OnClickListener,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.layout_sxzx_je, null);
		initViews(v);
		if (!NetworkUtils.isNetworkAvailable(getActivity()
			...
			mt = new MyAnsyTask();
			String params[] = { page + "", pagesize + "", "loanjine", "1" };
			mt.execute(params);
		}
		return v;
	}
