...
public class XszxDefaultFragment extends FragmentBase implements
	...
	public static final String GETINFO_URL = Constants.SERVICE_ADDRESS+"biao/getBiaoList";
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.layout_sxzx_default, null);
		initViews(v);
		if (!NetworkUtils.isNetworkAvailable(getActivity()
			...
			mt = new MyAnsyTask();
			String params[] = { page + "", pagesize + "", "addtime", "1" };
			mt.execute(params);
		}
		return v;
	}
