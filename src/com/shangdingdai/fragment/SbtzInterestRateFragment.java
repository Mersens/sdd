...
public class SbtzInterestRateFragment extends FragmentBase implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.layout_sbtz_lv, null);
		initViews(v);
		if (!NetworkUtils.isNetworkAvailable(getActivity()
			...
			mt = new MyAnsyTask();
			String params[] = { page + "", pagesize + "", "loanlilv", "0" };
			mt.execute(params);
		}
		return v;
	}
