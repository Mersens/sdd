...
public class HkzFragment extends FragmentBase implements OnClickListener,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.layout_hkz, null);
	...
	public void onRefresh() {
		...
		page = 1;
		mt = new MyAnsyTask();
		String params[] = { userid, page + "", pagesize + "", "huankuanzhong" };
		mt.execute(params);
	}
