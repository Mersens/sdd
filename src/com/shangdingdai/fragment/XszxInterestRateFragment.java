...
public class XszxInterestRateFragment extends FragmentBase implements
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.layout_sxzx_lv, null);
		initViews(v);
		if (!NetworkUtils.isNetworkAvailable(getActivity()
			...
			mt = new MyAnsyTask();
			String params[] = { page + "", pagesize + "", " loanlilv", "1" };
			mt.execute(params);
		}
		return v;
	}
