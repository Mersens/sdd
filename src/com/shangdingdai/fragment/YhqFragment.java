...
public class YhqFragment extends FragmentBase implements OnClickListener,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(R.layout.layout_yhq, null);
		...
		if (!NetworkUtils.isNetworkAvailable(getActivity()
			...
			mt = new MyAnsyTask();
			String params[] = { userid, page + "", pagesize + "", "yihuankuan" };
			mt.execute(params);
		}
		return v;
	}
