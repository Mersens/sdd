...
public class XtxxAdapter extends BaseListAdapter<GfggBean>{
	private List<GfggBean> list;
	public XtxxAdapter(List<GfggBean> list, Context context) {
		super(list, context);
		this.list=list;
	...
	public View getContentView(int position, View convertView, ViewGroup parent) {
		...
		holder.tv_time.setText(StringUtils.getFormatDate(bean.getTime()));
