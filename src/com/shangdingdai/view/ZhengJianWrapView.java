...
public class ZhengJianWrapView extends ViewGroup{
	  private static final int PADDING_HOR = 12;//水平方向padding
	   ...
	   * @param context
	   */
	  public ZhengJianWrapView(Context context) {
	    super(context);
	  }
	   ...
	   * @param defStyle
	   */
	  public ZhengJianWrapView(Context context, AttributeSet attrs, int defStyle) {
	   ...
	   * @param attrs
	   */
	  public ZhengJianWrapView(Context context, AttributeSet attrs) {
	    super(context, attrs);
	  }
